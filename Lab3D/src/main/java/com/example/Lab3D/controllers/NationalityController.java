...
import com.example.Lab3D.model.GetNationalitiesResponse;
...
public class NationalityController {
    public final String NATIONALITY_PATH = "/api/nationalities";
    public final String NATIONALITY_PATH_ID = NATIONALITY_PATH + "/{nationalityId}";
